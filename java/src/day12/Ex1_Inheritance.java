...
class Child extends Parent {
	...
	public void print() {
		...
		System.out.println(getZ()); // z에 직접적으로 접근할 수 없기 때문에 getter을 이용하여 접근한다. // private도 상속할순 있음...
		System.out.println(s); // 
	}
	public Child() {
		this(0,0,0,0);
		//super(0,0,0) : this()생성자와 super()생성자는 같이 쓸 수 없다. this()에서 부모 생성자를 이미 호출 했기 떄문에
